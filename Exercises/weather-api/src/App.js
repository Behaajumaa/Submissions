  ...
  getWeather = async (e) => {
    ...
    if (data.cod === "200") {
      ...
      this.setState({
        ...
        img1: getImg(data.list[1].weather[0].id),
        img2: getImg(data.list[2].weather[0].id),
        img3: getImg(data.list[3].weather[0].id),
        img4: getImg(data.list[4].weather[0].id),
        img5: getImg(data.list[5].weather[0].id),
        img6: getImg(data.list[6].weather[0].id),
        img7: getImg(data.list[7].weather[0].id),
